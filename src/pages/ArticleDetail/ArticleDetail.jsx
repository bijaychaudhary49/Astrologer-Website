      ...
      <section className="relative w-full h-[716px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full px-5 md:px-16 pb-12 max-w-[1280px] mx-auto">
          <div className="max-w-3xl">
            <span className="text-xs font-semibold text-royal-purple tracking-widest uppercase mb-4 block">
              {article.category}
            </span>
            <h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-primary mb-6 leading-tight">
              {article.title}
            </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <aside className="lg:col-span-4 space-y-12">
            ...
            <div className="sticky top-28 p-8 border border-theme bg-white">
              ...
              <Link
                to="/services"
                className="w-full block text-center border border-theme py-4 text-xs font-semibold uppercase tracking-widest hover:bg-cosmic-navy hover:text-white hover:border-cosmic-navy transition-all"
              >
                VIEW SERVICES
              </Link>
            </div>
